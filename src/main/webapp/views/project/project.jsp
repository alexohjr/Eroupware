...
<div class="projectMainArea">
	<!-- <a class="effect effect-4 newProjectBtn" href="#" title="Learn More">새로운 프로젝트</a> -->
	...
	<div class="projectListArea">
		...
		<div class="projectCardArea">
				<div class="projectCard newProjectBtn"><span>+</span></div>
			<c:forEach var="projectListDTO" items="${projectList }">
				<div class="projectCard" onclick="location.href='${pageContext.request.contextPath}/project/${projectListDTO.projectNo }'" style="background: ${projectListDTO.color }">
					<span class="titleSpan">${projectListDTO.title }</span>
					<span class="regdateSpan">${projectListDTO.regdate }</span>
					<span class="memberSpan">${projectListDTO.pmembers }명 참여중</span>
					<span class="percentSpan" data-percent="${projectListDTO.percent }"></span>
				</div>
			</c:forEach>
